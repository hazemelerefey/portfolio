...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        { label: 'Digilians (MCIT)', description: 'Applied AI & Data Analytics diploma program.', orbitIndex: 0, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'FWD Initiative (ITIDA)', description: 'Web Development Challenge level graduate.', orbitIndex: 1, position: 0.25, imageUrl: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'AI & Data Analytics', description: 'Python, SQL, machine learning, and Power BI.', orbitIndex: 0, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Frontend Development', description: 'React, Next.js, and modern web technologies.', orbitIndex: 1, position: 0.65, imageUrl: "https://images.unsplash.com/photo-1627398242454-45a1465c2479?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Graphic Design', description: 'Photoshop, motion graphics, and Blender 3D.', orbitIndex: 0, position: 0.85, imageUrl: "https://images.unsplash.com/photo-1558655146-9f40138edfeb?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ],
    journey: [
        { label: 'Football Player', description: 'Al-Nasr Club - Professional football, youngest in 3rd division.', orbitIndex: 0, position: 0.15, imageUrl: "https://images.unsplash.com/photo-1574629810360-7efbbe195018?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Frontend Developer', description: 'FWD Initiative - HTML5, CSS3, JavaScript, React.', orbitIndex: 1, position: 0.35, imageUrl: "https://images.unsplash.com/photo-1627398242454-45a1465c2479?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Graphic Designer', description: 'University Theatre Team - Official designer, award winner.', orbitIndex: 0, position: 0.55, imageUrl: "https://images.unsplash.com/photo-1558655146-9f40138edfeb?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'AI & Data Analyst', description: 'Digilians - Applied AI, machine learning, data analytics.', orbitIndex: 1, position: 0.75, imageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ],
    experience: [
        { label: 'Football', description: 'Al-Nasr Club - Youngest player in 3rd division.', orbitIndex: 0, position: 0.2, imageUrl: "https://images.unsplash.com/photo-1574629810360-7efbbe195018?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Frontend Dev', description: 'FWD Initiative - Web development fundamentals.', orbitIndex: 1, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1627398242454-45a1465c2479?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Graphic Design', description: 'Theatre Team - Visual identity & award-winning designs.', orbitIndex: 0, position: 0.65, imageUrl: "https://images.unsplash.com/photo-1558655146-9f40138edfeb?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'AI & Data', description: 'Digilians - Python, ML, data analytics, Power BI.', orbitIndex: 1, position: 0.85, imageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ]
};
